...
\begin{figure}[H]
	\centering
	\hspace*{-1.25cm}
	\includegraphics[scale=0.25]{ActFcn.jpg}
...
\begin{figure}[H]
	\centering
	\hspace*{-1.5cm}
	\includegraphics[scale=0.25]{DecreasingActFcn_realValues_good.jpg}
...
\begin{figure}[H]
	\centering
	\hspace*{-3.3cm}
	\includegraphics[scale=0.3]{jl_activation_good.jpg}
	\caption{joint limits activation function, generic values}
	\label{fig:jl_act_fnc}
\end{figure}
\noindent In the real task the value range for the $\dot{\bar{x}}$ is given from the \textit{joint limits values} of each joint.\\
\noindent \textbf{Task reference}:\\
