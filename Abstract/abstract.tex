...
The use of robotic systems in industrial applications has kept increasing since the 1960s. However, some tasks remain too complex or not cost-effective to rely completely on automation. With the advent of Industry 4.0, Human–Robot Collaboration (HRC) has emerged as a solution, enabling the creation of workcells where human and robotic agents coordinate their tasks to achieve a shared objective.
My work with this thesis focused on implementing and testing a unified architecture for the robotic agent used in the \textbf{SESTOSENSO project}, used to create a collaborative work-cell through the use of proximity and pressure sensors.
I explored the capabilities of the 12-DoF kinematic chain and proposed possible directions to improve the system’s functionalities. Moreover, this work also aimed to identify potential problems and weaknesses. I achieved these objectives through a series of simulated experiments, using a task-priority approach for system control, as I was interested in exploiting the high redundancy of the robot to perform multiple tasks simultaneously. I focused specifically on the task of \textit{obstacle avoidance}, implementing the safety system in a \textit{reactive control} framework. The implemented control algorithm allows the robot to navigate the environment and exploit the system redundancy to avoid the obstacles. It also exposes limitation of the approach, such as discontinuities due to the high frequency shift of the minimum distance point and reaching of illconditioned configuration due to the shapes of the obstacles.
