...
Given these operational requirements the most common \textit{mechanical design} follows the \textit{snake-like} design.
...
\end{itemize}
The other drive mode lack the necessary strength for most industrial application.\\
\noindent
