...
In this chapter, I illustrate the results of the \textit{state-of-the-art} research conducted for my thesis. The main topic of the review is \textit{hyper-redundant robotic systems}, and the chapter is subdivided into three parts.
\noindent
...
Looking at the work of \cite{liu2022review_hypMan1} and \cite{pistone2024modelling_hypMan2} is clear that \textit{hyper-redundant manipulator} are currently used in dangerous and thigh spaces, or in the medical field for surgery and as endoscopes.
